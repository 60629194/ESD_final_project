...
Serial.print(" | Time: "); Serial.print(durationUs); Serial.print(" us");
Serial.print(" | Speed: "); Serial.print(mbps, 4); Serial.print(" Mbps");
...
Serial.print(repairStatus); Serial.println(" missing/broken bytes.");
} else {
