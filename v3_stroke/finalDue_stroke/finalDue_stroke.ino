    ...
    if (isTimingBurst) {
      ...
      if (frames_received > 0) {
        ...
        if (repairStatus >= 0) {
            ...
            Serial.print(" 1. ESP32-C3 : "); Serial.print(t_c3); Serial.println(" us");
            Serial.println(" 2. ESP-NOW : ~2000 us (預估)");
            Serial.print(" 3. NodeMCU : "); Serial.print(t_node); Serial.println(" us");
            Serial.print(" 4. Due : "); Serial.print(durationUs); Serial.println(" us");
            Serial.println(" --------------------------------------");
